...
public static class Design
{
    ...
    public static Styles CreateStyles()
    {
        ...
        styles.Add(new Style(s=>s.OfType<Button>().Class("sidebarPrimary")){Setters={new Setter(TemplatedControl.BackgroundProperty,new Avalonia.Markup.Xaml.MarkupExtensions.DynamicResourceExtension("BrandDeep")),new Setter(TemplatedControl.BorderBrushProperty,new Avalonia.Markup.Xaml.MarkupExtensions.DynamicResourceExtension("BrandDeep")),new Setter(TemplatedControl.ForegroundProperty,new Avalonia.Markup.Xaml.MarkupExtensions.DynamicResourceExtension("OnAccent")),new Setter(TemplatedControl.CornerRadiusProperty,new CornerRadius(24)),new Setter(Layoutable.MinHeightProperty,48d)}});
